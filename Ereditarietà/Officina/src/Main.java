...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("--------");
        System.out.println("Vuoi proseguire con JSON? (s/n)");
        ...
        if (risposta.equals("s")) {
            ...
            try {
                ...
                concessionaria1.salvaJson(fileName);
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
            ...
            try {
                System.out.println("Inserisci il nome del file: ");
                String fileName = tastiera.nextLine();
                concessionaria1.leggiJson(fileName);
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else
...
//        ArrayList<Veicolo> officina = concessionaria1.getOfficina();
